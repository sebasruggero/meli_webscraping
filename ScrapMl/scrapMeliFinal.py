...
# Lista de productos
productos = [ "aceite de oliva","aceite de girasol", "arroz","tallarín", "leche descremada", "yerba", "azúcar", "harina", "fideos", "café", "té", "pañales", "papel higienico", "yogur", "queso", "galletas", "cereal", "agua mineral"]
