...
productos = ["aceite", "papel higienico", "yerba mate", "pañales","papel higienico", "leche descremada", "fernet", "coca cola"]

# Definir la duración de la pausa en segundos
pausa_entre_solicitudes = 2
...
for texto_busqueda in productos:
    ...
    print(f"Scraping completado para {texto_busqueda}. Los archivos CSV fueron exportados con éxito.")
